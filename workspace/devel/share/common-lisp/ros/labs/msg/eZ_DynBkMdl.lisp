...
(cl:defmethod cl:initialize-instance :after ((m <eZ_DynBkMdl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'eZ_DynBkMdl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name labs-msg:<eZ_DynBkMdl> is deprecated: use labs-msg:eZ_DynBkMdl instead.")))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <eZ_DynBkMdl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader labs-msg:s-val is deprecated.  Use labs-msg:s instead.")
  (s m))

(cl:ensure-generic-function 'ey-val :lambda-list '(m))
(cl:defmethod ey-val ((m <eZ_DynBkMdl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader labs-msg:ey-val is deprecated.  Use labs-msg:ey instead.")
  (ey m))

(cl:ensure-generic-function 'epsi-val :lambda-list '(m))
(cl:defmethod epsi-val ((m <eZ_DynBkMdl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader labs-msg:epsi-val is deprecated.  Use labs-msg:epsi instead.")
  (epsi m))

(cl:ensure-generic-function 'v_x-val :lambda-list '(m))
(cl:defmethod v_x-val ((m <eZ_DynBkMdl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader labs-msg:v_x-val is deprecated.  Use labs-msg:v_x instead.")
  (v_x m))

(cl:ensure-generic-function 'v_y-val :lambda-list '(m))
(cl:defmethod v_y-val ((m <eZ_DynBkMdl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader labs-msg:v_y-val is deprecated.  Use labs-msg:v_y instead.")
  (v_y m))

(cl:ensure-generic-function 'psi_dot-val :lambda-list '(m))
(cl:defmethod psi_dot-val ((m <eZ_DynBkMdl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader labs-msg:psi_dot-val is deprecated.  Use labs-msg:psi_dot instead.")
  (psi_dot m))
