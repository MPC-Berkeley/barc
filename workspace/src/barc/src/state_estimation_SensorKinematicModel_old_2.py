...
class StateEst(object):
    ...
    log_ay = zeros(10000)
    log_az = zeros(10000)
    log_roll = zeros(10000)
    log_pitch = zeros(10000)
    log_yaw = zeros(10000)
    imu_counter = 0
    ...
    def imu_callback(self, data):
        ...
        self.log_roll[self.imu_counter] = roll_raw
        self.log_pitch[self.imu_counter] = pitch_raw
        self.log_yaw[self.imu_counter] = yaw_raw
        ...
        # self.log_ax[self.imu_counter] = a_x
        # self.log_ay[self.imu_counter] = a_y
        # self.log_az[self.imu_counter] = a_z
        self.imu_counter += 1
        ...
        self.log_ax[self.imu_counter] = self.a_x_meas
        self.log_ay[self.imu_counter] = self.a_y_meas
        # self.log_az[self.imu_counter] = a_z
...
def state_estimation():
    ...
    # axis.plot(np.arange(10000), se.log_ax, "r-")
    # axis.plot(np.arange(10000), se.log_ay, "b-")
    # axis.plot(np.arange(10000), se.log_az, "k-")

    # axis.plot(np.arange(10000), se.log_roll, "r-")
    # axis.plot(np.arange(10000), se.log_pitch, "b-")
    axis.plot(np.arange(10000), se.log_yaw, "k-")
