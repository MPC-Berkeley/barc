...
def state_estimation():
    ...
    while not rospy.is_shutdown():
        ...
        state_pub_pos.publish(pos_info(Header(stamp=ros_t), l.s, l.ey, l.epsi, l.x, l.y, l.v_x, l.v_y,
                                       l.psi, l.psiDot, psi_drift_est, a_x_est, a_y_est, se.x_meas, se.y_meas, 
                                       se.yaw_meas, se.vel_meas, se.psiDot_meas,
                                       se.a_x_meas, se.a_y_meas, l.coeffCurvature.tolist()))
