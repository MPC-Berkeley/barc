...
function SE_callback(msg::pos_info,coeffCurvature_update::Array{Float64,1},z_est::Array{Float64,1},x_est::Array{Float64,1},
...
function main()
    ...
    s1 = Subscriber("pos_info", pos_info, SE_callback, (coeffCurvature_update,z_est,x_est,coeffX,coeffY,),queue_size=1)::RobotOS.Subscriber{barc.msg.pos_info}
