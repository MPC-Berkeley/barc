...
# ax2.plot(ecu_time, a_his, "--",   label="cmd.acc")
ax2.legend()
ax2.grid()
...
fig = plt.figure("Yaw")
ax1 = fig.add_subplot(1,1,1,ylabel="yaw")
ax1.plot(imu_time, yaw_his, ".", label="yaw_meas")
ax1.plot(estimator_time,yaw_est_his,label="yaw_est")
ax1.plot(gps_t[:-1], gps_yaw,label="yaw_gps")
ax1.plot(gps_time, gps_angle,label="angle_gps")
