...
from marvelmind_nav.msg import hedge_imu_fusion, hedge_pos_ang, hedge_pos
import numpy as np
...
class PlottedAgent:
    ...
    def __init__(self, color_string, ax, track):
        ...
        xy_gps_sub = rospy.Subscriber(node_name + "/hedge_pos", hedge_pos, self.xy_gps_callback)
...
class Plotter:
    ...
    def update(self, track):
        ...
        plt.savefig("~/images/image_" + str(self.count) + ".png")
