...
function solveMpcProblem_pathFollow(mdl::MpcModel_pF,mpcParams_pF::MpcParams,
                                    lapStatus::LapStatus,z_curr::Array{Float64,1},
    ...
    width_unit=width/(mpcParams_pF.N_lap-1)
