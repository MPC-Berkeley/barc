...
from marvelmind_nav.msg import hedge_imu_fusion, hedge_pos_a
...
def main():
    ...
    beacon  = rospy.get_param("/state_estimator/beacon")
...
class GpsClass(object):
    ...
    def __init__(self,t0, beacon):
        ...
        rospy.Subscriber('hedge_pos_a', hedge_pos_a, self.gps_callback, queue_size=1)
        self.beacon = beacon
