...
export ROS_IP=192.168.8.1                           # set IP address of this machine (micro-controller)
export ROS_MASTER_URI=http://192.168.8.127:11311    # set IP address of master machine
exec "$@"
